...
export const PaintBrushIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M18.2 3a2 2 0 0 0-2 2v2l-10 10c-1.4 1.5-2.8 2.8-4.2 4.2.8 1.2 1.6 2.4 2.8 3.2 1.2.8 2.4 1.2 3.6 1.2h2c1.2 0 2.4-.4 3.2-1.2.8-1.2 1.6-2.4 2.8-3.2 1.2-.8 2.4-1.6 3.2-2.8l2-2V5a2 2 0 0 0-2-2z"/><path d="m19 14-2-2"/><path d="m12 7 2 2"/></svg>
);

export const LeafIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M11 20A7 7 0 0 1 4 13V7a7 7 0 0 1 14 0v6a7 7 0 0 1-7 7z"/><path d="M12 4c-3.5 0-7 2.5-7 6v1a7 7 0 0 0 14 0V10c0-3.5-3.5-6-7-6z"/></svg>
);
...
export const ToolboxIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M22 7l-2.5 2.5"/><path d="M13.5 4L2 15.5 8.5 22l11.5-11.5L13.5 4z"/>
    <path d="M8 16l-1.5-1.5M10 14l-1.5-1.5M12 12l-1.5-1.5M14 10l-1.5-1.5"/>
    <path d="M16 8l-1.5-1.5M18 6l-1.5-1.5"/>
  </svg>
);
...
export const BroomIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M19.4 11.6c-1.3-1.3-1.3-3.5 0-4.8l1.2-1.2c.4-.4.4-1 0-1.4s-1-.4-1.4 0l-1.2 1.2c-1.3 1.3-3.5 1.3-4.8 0L3 15.2V21h5.8l9.6-9.6z"/><path d="M15 5l6 6"/>
  </svg>
);
...
export const LandmarkIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><line x1="3" y1="22" x2="21" y2="22"></line><line x1="6" y1="18" x2="6" y2="11"></line><line x1="10" y1="18" x2="10" y2="11"></line><line x1="14" y1="18" x2="14" y2="11"></line><line x1="18" y1="18" x2="18" y2="11"></line><polygon points="12 2 20 7 4 7"></polygon></svg>
);
...
export const MoreHorizontalIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" {...props}><circle cx="12" cy="12" r="1"></circle><circle cx="19" cy="12" r="1"></circle><circle cx="5" cy="12" r="1"></circle></svg>
);
...
export const PaperclipIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="m21.44 11.05-9.19 9.19a6 6 0 0 1-8.49-8.49l9.19-9.19a4 4 0 0 1 5.66 5.66l-9.2 9.19a2 2 0 0 1-2.83-2.83l8.49-8.48"></path></svg>
);

export const SparklesIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="m15 5-3.5 3.5 3.5 3.5 3.5-3.5-3.5-3.5Z"/><path d="M2.5 10.5 6 7l3.5 3.5L6 14l-3.5-3.5Z"/><path d="m18 22 3.5-3.5-3.5-3.5-3.5 3.5 3.5 3.5Z"/></svg>
);
export const PackageIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M16.5 9.4l-9-5.19M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/><polyline points="3.27 6.96 12 12.01 20.73 6.96"/><line x1="12" y1="22.08" x2="12" y2="12"/></svg>
);
...
export const WhatsAppIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}><path d="M16.6,14c-0.2-0.1-1.5-0.7-1.7-0.8c-0.2-0.1-0.4-0.1-0.6,0.1c-0.2,0.2-0.6,0.8-0.8,0.9c-0.1,0.2-0.3,0.2-0.5,0.1 c-0.2-0.1-1-0.4-1.9-1.1c-0.7-0.6-1.2-1.4-1.3-1.6c-0.1-0.2,0-0.4,0.1-0.5C9.9,10,10,9.9,10.1,9.7c0.1-0.1,0.2-0.2,0.2-0.4 c0.1-0.1,0-0.2,0-0.4C10.4,8.9,10,8.1,9.8,7.9C9.7,7.6,9.5,7.7,9.4,7.7c-0.1,0-0.3,0-0.4,0c-0.1,0-0.4,0.1-0.6,0.3 c-0.2,0.2-0.8,0.8-0.8,1.9c0,1.1,0.8,2.2,0.9,2.4c0.1,0.2,1.5,2.3,3.7,3.3c2.2,0.9,2.2,0.6,2.6,0.6c0.4,0,1.3-0.5,1.5-1 c0.2-0.5,0.2-0.9,0.1-1C17,14.2,16.8,14.1,16.6,14 M12,2C6.5,2,2,6.5,2,12c0,5.5,4.5,10,10,10c5.5,0,10-4.5,10-10C22,6.5,17.5,2,12,2 M12,20.2c-4.5,0-8.2-3.7-8.2-8.2c0-4.5,3.7-8.2,8.2-8.2c4.5,0,8.2,3.7,8.2,8.2C20.2,16.5,16.5,20.2,12,20.2"/></svg>
);